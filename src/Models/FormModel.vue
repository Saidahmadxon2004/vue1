<template>
  <form class="card p-4 shadow-sm border rounded-3">
    <h5 class="mb-4">Model Qo‘shish / Tahrirlash</h5>
    ...
    <div class="row mb-3">
      <div class="col-md-6">
        ...
        <input
          ...
          class="form-control"
          placeholder="Qo'shimcha birlik nomini yozing ..."
          required
        />
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      Send() {
        ...
        method='patch';
        url='api/v1/model/id/'+self.$route.params.id;
        }
        self.$axios({
          method: method,
          url: url,
