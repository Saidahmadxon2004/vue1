...
<template>
  <div class="container-fluid mt-3">
    <div class="pb-3 d-flex justify-content-between align-items-center">
      <h4 class="mb-0 fs-2 text-primary">Colours</h4>
      <button class="btn btn-primary btn-md" @click="$router.push('/addColour')">Qo'shish</button>
    </div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr v-for="(item, index) in data" :key="index">
            ...
            <td>{{ item.name }}</td>
            <td>
              <button class="btn btn-sm btn-warning me-1" @click="$router.push('/colour/update/' + item.id)">
