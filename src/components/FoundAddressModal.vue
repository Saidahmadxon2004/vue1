    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Bizni qayerdan topgan</h5>
  ...
  methods: {
    ...
    saveItem() {
      ...
      const url = this.editMode 
        ? `/api/v1/crm-found-address/id/${this.currentItem.id}`
        : '/api/v1/crm-found-address';
    ...
    deleteItem(id) {
      if (confirm("Haqiqatan ham o'chirmoqchimisiz?")) {
        this.$axios.delete(`/api/v1/crm-found-address/id/${id}`)
